...
The plot below shows the number of attendances to the ED of CMAST providers depending on the day of the week and the hour of the day.
...
The plot below shows the median time spent in the department, from arrival to departure, accompanied by the interquartile range and the 10th to 90th percentile range.
...
The plot below shows the outcome of patients attending ED and the onward destination, whether that be an admission, discharge or transfer to an alternate provider.
